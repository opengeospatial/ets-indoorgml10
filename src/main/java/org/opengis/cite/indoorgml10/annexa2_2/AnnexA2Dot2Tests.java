...
public class AnnexA2Dot2Tests extends CommonFixture {
	...
	/**
	 * Verify that the IndoorGML instance document follows the IndoorGML Indoor Navigation
	 * module’s rules for encoding of objects and properties and adheres to all its
	 * conformance requirements. This test case is mandatory for all IndoorGML instance
	 * documents which employ elements defined within the IndoorNavigation module A.2.2.1
	 * IndoorGML Indoor Navigation - Mandatory conformace requirements
	...
	public void verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirements() throws Exception {
		...
		String[] navigationModuleElementNames = { "NavigableSpace", "GeneralSpace", "TransferSpace", "AnchorSpace",
				"AnchorSpaceType", "ConnectionSpace", "TransitionSpace", "Route", "NavigableBoundary",
				"TransferBoundary", "ConnectionBoundary", "AnchorBoundary", "RouteSegment", "RouteNode" };
	 ...
	 * conformance requirements. This test case is mandatory for all IndoorGML instance
	 * documents which employ elements defined within the IndoorNavigation module A.2.2.1
	 * IndoorGML Indoor Navigation - Mandatory conformace Requirement 5
	 * @throws java.lang.Exception If something goes wrong
	 */
	@Test(description = "OGC 14-005r5, A.2.2.1 - Requirement 5",
			dependsOnMethods = "verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirements")
	 ...
	 * conformance requirements. This test case is mandatory for all IndoorGML instance
	 * documents which employ elements defined within the IndoorNavigation module A.2.2.1
	 * IndoorGML Indoor Navigation - Mandatory conformace Requirement 6
	 * @throws java.lang.Exception If something goes wrong
	 */
	@Test(description = "OGC 14-005r5, A.2.2.1 - Requirement 6",
			dependsOnMethods = "verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirements")
	public void verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirement6() throws Exception {
		...
		if (connectionSpaceList.getLength() > 0 || anchorSpaceList.getLength() > 0) { // we
																						// assert
																						// that
																						// if
																						// file
																						...
																						// thin
																						// doors
			Assert.assertTrue(connectionBoundaryList.getLength() == 0 && anchorBoundaryList.getLength() == 0,
					ErrorMessageKeys.THICK_DOOR_MODEL_EITHER_CONNECTIONSPACE_OR_ANCHORSPACE);
		}
	 ...
	 * conformance requirements. This test case is mandatory for all IndoorGML instance
	 * documents which employ elements defined within the IndoorNavigation module A.2.2.1
	 * IndoorGML Indoor Navigation - Mandatory conformace Requirement 7
	 * @throws java.lang.Exception If something goes wrong
	 */
	@Test(description = "OGC 14-005r5, A.2.2.1 - Requirement 7",
			dependsOnMethods = "verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirements")
	public void verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirement7() throws Exception {
		...
		if (connectionBoundaryList.getLength() > 0 || anchorBoundaryList.getLength() > 0) { // we
																							// assert
																							// that
																							// if
																							// file
																							...
																							// thick
																							// doors
			Assert.assertTrue(connectionSpaceList.getLength() == 0 && anchorSpaceList.getLength() == 0,
					ErrorMessageKeys.THIN_DOOR_MODEL_EITHER_CONNECTIONBOUNDARY_OR_ANCHORBOUNDARY);
		}
	}
	 ...
	 * conformance requirements. This test case is mandatory for all IndoorGML instance
	 * documents which employ elements defined within the IndoorNavigation module A.2.2.1
	 * IndoorGML Indoor Navigation - Mandatory conformace Requirement 8
	 * @throws java.lang.Exception If something goes wrong
	 */
	@Test(description = "OGC 14-005r5, A.2.2.1 - Requirement 8",
			dependsOnMethods = "verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirements")
	public void verifyIndoorGMLIndoorNavigationMandatoryConformaceRequirement8() throws Exception {

		if (skipIncompleteTests)
	 ...
	 * definition of the IndoorGML Indoor Navigation module. This test case is mandatory
	 * for all IndoorGML instance documents. A.2.2.2 IndoorGML Indoor Navigation - Valid
	 * IndoorGML instance document
	 * @throws java.io.IOException If something goes wrong with input
	 * @throws java.net.MalformedURLException If a URL is malformed
	 */
	@Test(description = "OGC 14-005r5, A.2.2.2")
	public void verifyIndoorGMLIndoorNavigationValidIndoorGMLInstanceDocument()
